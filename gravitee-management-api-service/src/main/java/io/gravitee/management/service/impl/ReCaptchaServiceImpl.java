...
public class ReCaptchaServiceImpl implements ReCaptchaService {
    ...
    public boolean isValid(String token) {
        ...
        try {
            ...
            Buffer response = httpClientService.request(HttpMethod.POST, serviceUrl, Collections.emptyMap(), "secret=" + secretKey + "&response=" + token, false);
            ...
            //result should be sucessful and spam score above 0.5
